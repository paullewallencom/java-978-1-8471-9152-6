 ...
 * <ul>
 *  <li><b>jdbcClass</b> - the JDBC Driver class name.</li>
 *  <li><b>jdbcUrl</b> - the JDBC Url.</li>
 *  <li><b>jdbcUser</b> - the JDBC User to access the database.</li>
 *  <li><b>jdbcPass</b> - the JNDI Password to access the database.</li>
 *  <li><b>datasource</b> - the JNDI location for the DataSource that is to be used.
 *  if both jdbc* and datasource are specified, the latter has priority.</li>
...
public class JDBCWorkflowStore implements WorkflowStore {
    ...
    public void init(Map props) throws StoreException {
        System.out.println("NAYA NAYA NAYA");
        ...
        if (jndi != null) {
        	...
        	String jdbcClass = (String) props.get("jdbcClass");
        	try {
				Class.forName(jdbcClass);
			} catch (ClassNotFoundException e) {
				throw new StoreException("Error loading jdbc driver class: [" + jdbcClass + "]", e);
			}
        	 jdbcUser = (String) props.get("jdbcUser");
        	 jdbcPass = (String) props.get("jdbcPass");
        	 jdbcUrl = (String) props.get("jdbcUrl");
        }
    }
