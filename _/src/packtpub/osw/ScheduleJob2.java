 ...
 */
public class ScheduleJob2 implements FunctionProvider {
    //~ Static fields/initializers /////////////////////////////////////////////

    private static final Log log = LogFactory.getLog(ScheduleJob2.class);
    ...
    public void execute(Map transientVars, Map args, PropertySet ps) {
        try {
            ...
            JobDataMap dataMap = new JobDataMap(args);
